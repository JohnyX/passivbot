    ...
    return {
        ...
        "bot": {
            "long": {
                ...
                "filter_atr_max_threshold": 0.0,
                "filter_atr_rolling_window": 0,
        ...
        "optimize": {
            "bounds": {
                ...
                "long_filter_atr_max_threshold": [0.001, 100.0],
                "long_filter_atr_rolling_window": [0.0, 1440.0],
                ...
                "short_filter_atr_max_threshold": [0.001, 100.0],
                "short_filter_atr_rolling_window": [0.0, 1440.0],
